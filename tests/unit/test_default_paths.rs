...
fn test_default_config_uses_user_home_plugins() {
    ...
    println!("✅ Default config uses ~/.aetheric/plugins: {}", config.plugins.install_dir.display());
    println!("✅ Default config uses ~/.aetheric/tmp: {}", config.plugins.temp_dir.display());
    println!("✅ Default config uses ~/.aetheric/certs: {}", config.certificates.cert_dir.display());
}
...
fn test_path_expansion() {
    ...
    println!("✅ Path expansion works: {} -> {}", tilde_path.display(), expanded.display());
}
